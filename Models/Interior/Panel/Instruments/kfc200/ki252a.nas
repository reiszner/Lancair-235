...
var fdprop = props.globals.getNode("/instrumentation/ki252a",1);
var lnav = 0;
var vnav = 0;
var current_alt=0.0;
var alt_select = 0.0;
...
setlistener("/sim/signals/fdm-initialized", func {
  ...
  #setprop("/autopilot/locks/altitude",V_list[vnav]);
  #setprop("/autopilot/locks/heading",L_list[lnav]);
...
var update = func {
  ...
  if (getprop("/position/altitude-agl-ft") < DH) {
    ...
    props.globals.getNode("/autopilot/locks/passive-mode").setBoolValue(0);
