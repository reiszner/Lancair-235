...
#  Override static configuration to route props from Nav1/Nav2/KNS80 to KI525 displayt
selectNavSrce = func ( tIndx = 0) {
  ...
  var   nav_srce_prop = "/instrumentation/kcs55/ki525/nav-srce-index";
  # nav-srce/selector is 0-indexed: select 0  for Nav 1  
  var   nav_sele_prop = "/instrumentation/nav-source/selector";
  ##
  ...
  #
  setprop( nav_srce_prop, tIndx);
  if (tIndx == 2 ) {
    setprop( nav_sele_prop, 1);
    ...
    setprop( nav_sele_prop, 0);
    sele_crse_srce_node = "instrumentation/nav[1]/radials/selected-deg";
    cdi_defl_srce_node = "instrumentation/nav[1]/heading-needle-deflection-norm";
    gs_defl_srce_node = "instrumentation/nav[1]/gs-needle-deflection-norm";
    to_flag_srce_node = "/instrumentation/nav[1]/to-flag";
    from_flag_srce_node = "/instrumentation/nav[1]/from-flag";
    nav_flag_srce_node = "/instrumentation/nav[1]/nav-flag";
  } else {
    setprop( nav_srce_prop, 0);
    setprop( nav_sele_prop, 0);
